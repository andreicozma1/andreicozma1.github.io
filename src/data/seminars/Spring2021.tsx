	...
	title: "Spring 2021", items: [
		{
			...
			"title"     : "In-space Manufacturing", "subtitle": "Presenter: Tracie Prater of NASA",
			"avatar"    : <AccessAlarmIcon/>, "chips": {
				"date": [ "03/02/2021" ]
			}, "content": [
			...
			"title"     : "CHP Overview - All Cohorts", "subtitle": "Presenter: Rebekah Page",
			"avatar"    : <AccessAlarmIcon/>, "chips": {
				"date": [ "01/21/2021" ]
			}, "content": [
