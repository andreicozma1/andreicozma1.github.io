...
const Cybersecurity: PageSectionProps = {
	title: "Cybersecurity", variant: "grid6", items: [
		{
			"title"    : "COSC 466 - Software Security", "subtitle": `An in-depth introduction to software security. The focus is on identifying vulnerabilities in software, 
						exploiting vulnerabilities in software, and software development best practices for avoiding vulnerabilities 
						during the design, implementation, testing, and deployment of software.`, "chips": {
				"contentChips": [
					"Threat Modeling", "Security Architecture", "Security Testing", "Security Analysis"
				], "languages": [ "X86 Assembly", "C/C++", "Python", "JavaScript" ]
			}, "avatar": <AccessAlarmIcon/>
		}, {
			"title"    : "ECE 462 - Cyber-Physical System Security", "subtitle": `Introduction to security challenges and techniques at both the physical layer and the cyber layer of important 
			cyber-physical systems.`, "chips": {
				"contentChips": [
			...
			"title"    : "ECE 469 - Mobile/Embedded Systems Security", "subtitle": `Introduction to vulnerabilities and threat vectors associated with mobile and embedded devices, 
			such as smartphones, wearable devices, and IoT devices.`, "chips": {
				"contentChips": [
