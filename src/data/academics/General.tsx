...
const General: PageSectionProps = {
	...
	items  : [
        ...
        methodologies of operating systems. Enforcing efficient analysis and problem solving skills, the understanding of a variety of software tools,
        ...
        effective software solutions.`,
			"chips"   : {
				"contentChips": [
					"Operating Systems", "Memory Management", "Process Management", "System Calls", "Buffering",
					"Interprocess Communication", "File Systems", "File I/O", "Directory Management", "Metadata",
					"Assembly Code", "Stack Frames"
				],
				"languages"   : [ "C/C++" ],
				"tools"       : [ "Git" ]
			}
