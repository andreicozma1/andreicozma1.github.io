...
const General: PageSectionProps = {
	title: "General", variant: "grid6", items: [
		{
			...
			"title": "COSC 493 - Advanced Automata Theory", "avatar": <AccessAlarmIcon/>, "subtitle": `Working on the development of a Turing Machine to be used as an educational aid to students. 
			...
			"chips": {
				...
				], "languages": [ "Java" ], "libraries": [ "JavaFX" ], "tools": [ "Git" ]
			}
		}, {
			"title"   : "COSC 465 - Databases and Scripting Languages", "avatar": <AccessAlarmIcon/>,
			...
			"chips"   : {
				"contentChips": [
					...
					"Web Databases"
				], "languages": [ "HTML", "CSS", "JavaScript", "PHP", "SQL" ], "libraries": [ "Node.JS", "JQuery" ],
				"tools"       : [ "MongoDB", "Git" ]
			}

		}, {
			"title" : "COSC 370 - Introduction to Scientific Computing", "subtitle": `An in-depth focus on the implementation, analysis, and design of numerical algorithms with
			...
			"avatar": <AccessAlarmIcon/>, "chips": {
				...
				], "languages": [ "Python" ], "libraries": [ "Numpy", "Matplotlib" ], "tools": [ "Git" ]
			}
		}, {
			"title": "COSC 367 - Honors Systems Programming", "avatar": <AccessAlarmIcon/>, "subtitle": `An in-depth introduction to the C programming language and its use in systems programming, covering the
        ...
        effective software solutions.`, "chips": {
				"contentChips": [
				...
				], "languages": [ "C/C++" ], "tools": [ "Git" ]
			}

		}, {
			"title": "COSC 365 - Programming Languages and Systems", "avatar": <AccessAlarmIcon/>, "subtitle": `An in-depth study of the design, implementation, and application of programming languages as well as an introduction to the basics of operating systems.
			...
			"chips": {
				...
				"libraries"   : [ "Node.JS", "JQuery" ], "tools": [ "Git" ]
			}
		}, {
			"title": "COSC 361 - Operating Systems", "avatar": <AccessAlarmIcon/>, "subtitle": `In-depth study of the design, implementation, and performance of modern operating systems with a focus on Unix and a modern re-implementation of 6th edition Unix called XV6.
			...
			"chips": {
				...
				], "languages": [ "C/C++" ], "tools": [ "Unix", "Linux", "Git" ]
			}
		}, {
			"title": "COSC 340 - Software Engineering", "avatar": <AccessAlarmIcon/>, "subtitle": `A strong focus on the application of a systematic, disciplined, quantifiable approach to the design,
        ...
        of Processes, Models and Methods, etc.`, "chips": {
				"contentChips": [
				...
				], "languages": [ "Python" ], "tools": [ "Git", "GitHub", "GitHub Actions" ]
			}
		}, {
			"title": "COSC 317 - Honors Discrete Structures", "avatar": <AccessAlarmIcon/>, "subtitle": `Introduction to Set Theory, Graph Theory, and Logic & Proof strategies as the principles of software
        ...
        combinatorics.`, "chips": {
				...
				], "languages": [ "Python" ], "tools": [ "Git" ]
			}
		}, {
			"title": "COSC 312 - Algorithm Analysis and Automata", "avatar": <AccessAlarmIcon/>, "subtitle": `This course is an introduction to the Theory of Computation, the logic of computation with respect to
        ...
        of algorithms.`, "chips": {
			...
			"title": "COSC 307 - Honors Data Structures and Algorithms II", "avatar": <AccessAlarmIcon/>, "subtitle": `This course focuses on the application of fundamental data structures and associated algorithms most
        ...
        `, "chips": {
				...
				], "languages": [ "C/C++" ], "tools": [ "Git", "GitHub", "GitHub Actions" ]
			}
		}, {
			"title": "COSC 140 - Data Structures and Algorithms I", "avatar": <AccessAlarmIcon/>, "subtitle": `Development and application of a multitude of data structures and algorithms proeminently used in software
        ...
        complexity and running times, I/O techniques, lists, queues, stacks, hash tables, files, etc.`, "chips": {
				"contentChips": [
			...
			"title": "COSC 130 - Computer Organization & Architecture", "avatar": <AccessAlarmIcon/>, "subtitle": `Hands-on experience with applying computer organization and architecture techniques while developing
        ...
        organization, and assembly language programming.`, "chips": {
				"contentChips": [
			...
			"title": "COSC 102 - Introduction to Computer Science", "avatar": <AccessAlarmIcon/>, "subtitle": `Introduction and hands-on experience with the basics of programming languages, problem solving, and
        ...
        a modern computer language.`, "chips": {
				"contentChips": [
