...
const Completed: CardListParams = {
	title: "Intelligent Systems", layout: SectionCardList, itemComponent: InfoCardAccordion, items: [
		{
			"title": "COSC 525 - Deep Learning", "avatar": <AccessAlarmIcon/>, "content": null
		}, {
			"title": "COSC 523 - Artificial Intelligence", "avatar": <AccessAlarmIcon/>, "content": [
			...
			"title": "COSC 522 - Machine Learning", "avatar": <AccessAlarmIcon/>, "content": [
        ...
        support vector machines, decision trees, boosting, and neural networks.`
			...
			"title": "COSC 420 - Biologically-Inspired Computation", "avatar": <AccessAlarmIcon/>, "content": null
		}
	]
}
