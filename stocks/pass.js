...
function refresh(){
    ...
    var stocks1 = document.getElementById("stocks");
    var stocks2 = document.getElementById("stocks1");
    stocks1.style.width = window.innerWidth;
    stocks1.style.height = window.innerHeight;
    stocks2.style.width = window.innerWidth;
    stocks2.style.height = window.innerHeight;
